...
import cn.edu.bupt.sdmda.ds.linearlist.MyLinkedList.Node;

public class xunhuanlianbiao<T> implements LinearList<T>{
	...
	public xunhuanlianbiao(int s, T init) {
		// TODO Auto-generated constructor stub
		init(s,init);
	}

	public xunhuanlianbiao() {
		// TODO Auto-generated constructor stub
		init(0, null);
	}
